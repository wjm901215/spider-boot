...
package com.spider.ma.modules.job.service.impl;
...
import com.spider.ma.modules.job.dao.ScheduleJobDao;
import com.spider.ma.modules.job.entity.ScheduleJobEntity;
import com.spider.ma.modules.job.service.ScheduleJobService;
import com.spider.ma.modules.job.utils.ScheduleUtils;
...
public class ScheduleJobServiceImpl extends ServiceImpl<ScheduleJobDao, ScheduleJobEntity> implements ScheduleJobService {
	...
	public void save(ScheduleJobEntity scheduleJob) {
		...
		scheduleJob.setStatus(BaseConstants.ScheduleStatus.NORMAL.getValue());
    ...
    public void pause(String[] jobIds) {
    	...
    	updateBatch(jobIds, BaseConstants.ScheduleStatus.PAUSE.getValue());
    }
    ...
    public void resume(String[] jobIds) {
    	...
    	updateBatch(jobIds, BaseConstants.ScheduleStatus.NORMAL.getValue());
    }
